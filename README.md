...
| [Axial attention in multidimensional transformers](https://arxiv.org/abs/1912.12180) | *arXiv preprint, 2019* | [Code](GITHUB_LINK) |
| [Generating long sequences with sparse transformers](https://arxiv.org/abs/1904.10509) | *arXiv preprint, 2019* | [Code](GITHUB_LINK) |
...
| [Highly accurate protein structure prediction with AlphaFold](https://www.nature.com/articles/s41586-021-03819-2) | *Nature, 2021* | [Code](GITHUB_LINK) |
...
| [Evolutionary-scale prediction of atomic-level protein structure with a language model](https://www.science.org/doi/10.1126/science.ade2574) | *Science, 2023* | [Code](GITHUB_LINK) |
...
| [Protein representation learning by geometric structure pretraining](https://arxiv.org/abs/2203.06125) | *arXiv preprint, 2022* | [Code](GITHUB_LINK) |
| [Continuous-discrete convolution for geometry-sequence modeling in proteins](https://openreview.net/forum?id=P5Z-Zl9XJ7) | *ICLR, 2022* | [Code](GITHUB_LINK) |
...
| [Foldseek: fast and accurate protein structure search](https://www.biorxiv.org/content/10.1101/2022.02.07.479398v5) | *bioRxiv, 2022* | [Code](GITHUB_LINK) |
...
| [ProteinBERT: a universal deep-learning model of protein sequence and function](https://academic.oup.com/bioinformatics/article/38/8/2102/6502274) |  | [Code](GITHUB_LINK) |
| [Bertology meets biology: Interpreting attention in protein language models](https://arxiv.org/abs/2006.15222) | *arXiv preprint, 2020* | [Code](GITHUB_LINK) |
| [Prottrans: Toward understanding the language of life through self-supervised learning](https://ieeexplore.ieee.org/document/9477085) | *IEEE Transactions on Pattern Analysis and Machine Intelligence, 2021* | [Code](GITHUB_LINK) |
| [Modeling protein using large-scale pretrain language model](https://arxiv.org/abs/2108.07435) | *arXiv preprint, 2021* | [Code](GITHUB_LINK) |
